        ...
        if ($finalization['isSuccess'] == 1) {
            ...
            $html = '
                ...
                <div class="row header">
                    ...
                    <div class="col-12 header-text text-center">
                        ...
                        OLLH Employee eTriage Hospital Pass
                    </div>
                </div>

                <div class="row text-center header">
                    <div class="col-12 header-text margin-top">eTriage Health Declaration Status : </div>
                    <div class="col-12">
            ...
            $response['content']['form'] = "
                <div class='text-center margin-top-lg'>
                    ...
                    <p>Starting October 12, 2020, our AGF Security Guards will now require the OLLH Employees, Doctors & other personel the Hospital Pass upon entry. </p>

                    <p>Hospital Pass will be automatically generated by the ESurvey Application through the email you provided once a <b>Successfull eTriage</b> response has been done.</p>

                    <p>You may also download your latest Hospital Pass <a target='_blank' href='{$file['weblink']}'>here</a> for your easy access.</p>
                </div>
                <div class='text-center margin-top-lg'>
